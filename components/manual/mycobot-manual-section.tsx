...
const STRINGS: Record<ManualLang, Strings> = {
  CAST: {
    ...
    start:
      "Abre MycoBot con el botón del lateral derecho y escribe tu pregunta en lenguaje natural. Escribe /help en cualquier momento para volver a ver esta ayuda dentro del chat.",
    gatedNote:
  ...
  CAT: {
    ...
    start:
      "Obre MycoBot amb el botó del lateral dret i escriu la teva pregunta en llenguatge natural. Escriu /help en qualsevol moment per tornar a veure aquesta ajuda dins del xat.",
  ...
  GAL: {
    ...
    start:
      "Abre MycoBot co botón do lateral dereito e escribe a túa pregunta en linguaxe natural. Escribe /help en calquera momento para volver ver esta axuda dentro do chat.",
  ...
  EUS: {
    ...
    start:
      "Ireki MycoBot eskuineko aldeko botoiarekin eta idatzi zure galdera hizkuntza naturalean. Idatzi /help edonoiz laguntza hau txataren barruan berriz ikusteko.",
